...
<div class="employe-loan-form  panel panel-default" style="margin-top:15px;">
  <div class="panel-heading" style="margin-bottom:16px;"><h3>
    ...
    margin-bottom: 7px;"></span>رد سلف العاملين</h3></div>

    <?php $form = ActiveForm::begin(); ?>
    <div class="col-md-6 inner-addon right-addon">
      <i class="glyphicon glyphicon-euro" ></i>
    <?= $form->field($model, 'loan_back_cost')->textInput(['maxlength' => true]) ?>
</div>
...
<div class="form-group" style="margin-right:16px;" >
    <?= Html::submitButton($model->isNewRecord ?'<span class="glyphicon glyphicon-euro pad"></span>رد سلفة':'<span class="glyphicon glyphicon-euro  pad"></span>تعديل السلفة', ['class' =>$model->isNewRecord ? 'btn btn-outline-danger':'btn btn-outline-danger']) ?>
