...
<div class="employe-loan-form  panel panel-default" style="margin-top:15px;">
  <div class="panel-heading" style="margin-bottom:16px;"><h3>
    ...
    <?= $form->field($model, 'part_cost')->textInput(['maxlength' => true]) ?>
</div>
...
<div class="form-group" style="margin-right:16px;" >
    <?= Html::submitButton($model->isNewRecord ?'<span class="glyphicon glyphicon-euro pad">

    </span>إضافة مبلغ مستقطع':'<span class="glyphicon glyphicon-euro  pad"></span>تعديل المستقطع', ['style'=>'    width: 190px;','class' =>$model->isNewRecord ? 'btn btn-outline-primary':'btn btn-outline-danger']) ?>
