...
<div ng-app="myApp" ng-controller="indoorHistoryReportCtrl">
...
<div class="clearfix"></div>
      ...
      <div class="row" id="report">
        <?='   <p class="total text-center space">جرد المخزن الداخلي &nbsp;&nbsp;' . date("d/m/Y")?>
           </p>
...
<tr>
 ...
 <p class="total text-center space">إجمالي المستلزمات  =  {{calcTotal(data)}} جنيه
